...
| fedotracker.py       | [Fedo Treacker](https://feodotracker.abuse.ch/) | N/A | -h, -f, --file=<file> |                                                      Doesn't have an API endpoint at the moment, so I parsed the request from the HTML data                                       |
